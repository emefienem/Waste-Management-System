...
//         <AnimatedGlobe />
//         <h1 className="text-6xl font-bold mb-6 text-gray-800 tracking-tight">
//           <span className="text-green-600">Waste Management System</span>
//         </h1>
//         <p className="text-xl text-gray-600 max-w-2xl mx-auto leading-relaxed mb-8">
//           Join our community to make waste management motre efficient and
//           rewards
//         </p>
...
//           icon={Leaf}
//           title="Eco-Friendly"
//           description="We are committed to reducing waste and promote sustainability"
//         />
...
//           <ImpactCard title="CO2 Offset" value={"20kg"} icon={Leaf} />
//         </div>
//       </section>
//     </div>
//   );
...
//       </div>
//       <h3 className="text-xl font-semibold mb-4 text-gray-800">{title}</h3>
//       <p className="text-gray-600 leadinng-relaxed">{description}</p>
//     </div>
//   );
// }
...
// }) {
//   return (
//     <div className="p-6 rounded-xl bg-gray-50 border border-gray-100 transition-all duration-300 ease-in-out">
//       <Icon className="h-10 w-10 text-green-500 mb-4" />
//       <p className="text-3xl font-bold mb-2 text-gray-800">{value}</p>
//       <p className="text-3xl font-bold mb-2 text-gray-800">{title}</p>
//     </div>
//   );
// }
